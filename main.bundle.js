	...
	var MealTable = function () {
	  ...
	  _createClass(MealTable, [{
	    ...
	    value: function title(word) {
	      word.atChar(0).toUpperCase() + word.slice(1);
	    }
	    ...
	    key: 'make_meal_stats',
	    value: function make_meal_stats() {
	      // let stats = this.make_stats_section(this.className, this.idBase )
	      var stats = this.make_stats_section();
	      return stats;
	    }
	    ...
	    value: function make_stats_section() {
	      ...
	      var statsBody = this.stats.add_statistics_table_body(table, this.idBase, this.className);
	      // let sumRow    = this.make_calorie_total(statsBody, sum, this.idBase, this.className)
	      var sumRow = this.make_calorie_total(statsBody, sum);
	    ...
	    value: function make_calorie_total(statBody, total) {
	      ...
	      var sum = this.stats.add_statistics_table_row(statBody, data, this.idBase, this.className);
	      return sum;
	    }
	    ...
	    value: function make_goal_total_row(sumRow) {
	      ...
	      var stats = document.getElementById(this.idBase + 'Statistics');
