...
debugger
if (path.includes('/meals.html')) { debugger; makeMealsPage() }
if (path.includes('/foods.html')) { debugger; makeFoodsPage() }
if (path.includes('/index.html') || path.endsWith('/')) { debugger; makeHomePage() }
